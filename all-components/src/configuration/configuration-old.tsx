...
// }
// function CustomRangeWidget({value, readonly, disabled, onBlur, onFocus, schema, onChange, required, label, id}: WidgetProps): JSX.Element {
...
//     // const incorrectLinkFormatErrorMsg = 'invalid context link format'
//     // const regexForContextLink = /(?<=\{{)([0-9a-zA-Z\[\]\._]*)(?=\}})/g
...
//                     // if(enabledLinksMap.has(prefix) && !enabledLinksMap.get(prefix)?.match(regexForContextLink)?.length){
//                     //     (obj as FormValidation).addError(incorrectLinkFormatErrorMsg)
//                     // }
